...
class ProductController extends BaseController
{
    ...
    public function store(ProductsFormRequest $request)
    {
        ...
        product_history($product, 'creación', auth()->user()->id, $prToArray);
    ...
    public function update(ProductsFormRequest $request)
    {
        ...
        product_history($product, 'actualiza', auth()->user()->id, $prToArray);
    ...
    public function iva_update(Request $request)
    {
        ...
        product_history($product, 'se cambia iva', auth()->user()->id, $product->iva->toArray());
    ...
    public function image_remove()
    {
        try {
            ...
            product_history($product, 'se elimina imagen', auth()->user()->id, $product->toArray());
    ...
    public function add_stock()
    {
        ...
        product_history($product, 'agrega stock', auth()->user()->id, ['cantidad' => $stock]);
    ...
    public function delete_product()
    {
        try {
            ...
            product_history($product, 'eliminado', auth()->user()->id, $product->toArray());
