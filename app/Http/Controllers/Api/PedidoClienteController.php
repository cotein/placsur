...
class PedidoClienteController extends Controller
{
    ...
    {   
        ...
        if (request()->has('code')) {
            ...
            $pcs = $pcs->select('id', 'code', 'customer_id', 'created_at', 'delivery_date', 'total', 'status_id', 'meli_data', 'voucher_id', 'date')
        ...
        $pcs = $pcs
            ->select('id', 'code', 'customer_id', 'created_at', 'delivery_date', 'total', 'status_id', 'meli_data', 'voucher_id', 'date')
            ->orderBy('created_at', 'desc')
            ->paginate(20);
    ...
    public function save_order(PedidoCliente $pc, $pedido){
        ...
        try {
            ...
            event('eloquent.finished: ' . PedidoCliente::class, $pc);
