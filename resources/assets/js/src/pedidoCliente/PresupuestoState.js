...
class PresupuestoState extends InterfaceStatus {
    ...
    async executeAction(){
        ...
        let new_presupuesto = await this.savePresupuesto(); 
    ...
    printPdf(presupuesto)
    {
        ...
        if (presupuesto.customer_address) {
            console.log("🚀 ~ file: PresupuestoState.js ~ line 47 ~ PresupuestoState ~ presupuesto.addresses", presupuesto.customer_address)
        ...
        const pdf = new PresupuestoPdf()
            ...
            .setVoucherPayCondition({condition : 'Condición de Pago:', fch_vto : `Fecha de vencimiento:`})
            ...
            console.log("🚀 ~ file: PresupuestoState.js ~ line 82 ~ PresupuestoState ~ pdf", pdf);
