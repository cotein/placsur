    ...
    control_stock(){
        ...
        this.data.items.map((item) => {
            ...
            if (item.isCHP) {
                ...
                //console.log("🚀 ~ file: RemitidoState.js:38 ~ RemitidoState ~ this.data.items.map ~ indexDisponibleStock:", indexDisponibleStock)

                const sheet_metal_cuttings = disponibleStock[indexDisponibleStock];
                //console.log("🚀 ~ file: RemitidoState.js:35 ~ RemitidoState ~ this.data.items.map ~ sheet_metal_cuttings:", sheet_metal_cuttings)
