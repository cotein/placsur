...
class PedidoClientePdf extends InvoiceTypeB {
    ...
    details_of_product(title){
        ...
        console.log("🚀 ~ file: PedidoClientePdf.js:145 ~ PedidoClientePdf ~ details_of_product ~ height_position", this.voucher)
        let current_page = 1;
    ...
    generatePdf(titles){
        ...
        titles.forEach((title) => {
            ...
            if (obs_dimensions.w > 158) {
                ...
                let array_text_obs = this.pdf.splitTextToSize(this.customer.obs, 158);

                array_text_obs.forEach((line, i) => {
                    if (i == 0) {
