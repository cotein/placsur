    ...
    details_of_product(title){
        ...
        collect(this.voucher.details_product).each((product, index) => {
            ...
            if (product_name_width.w > 135) {
                console.log("🚀 ~ file: PresupuestoPdf.js:66 ~ PresupuestoPdf ~ collect ~ product_name_width.w :", product_name_width.w )
                ...
                array_text.forEach((line, i) => {
                    ...
                    height_position = height_position + 4;
                    console.log("🚀 ~ file: PresupuestoPdf.js:71 ~ PresupuestoPdf ~ array_text.forEach ~ height_position:", height_position)
                });
            ...
            this.pdf.setFontSize(this.size_text_details);
            //##### TOTAL ######
            this.pdf.text(this.CurrencyFormat(product.total_Presupuesto), width_position, height_position, options);
