    ...
    export default {
        ...
        methods : {
            ...
            async excel(){
                ...
                if (invoices) {
                    console.log("🚀 ~ file: InvoiceListTable.vue:300 ~ excel ~ invoices", invoices)
                    ...
                    /* const pp = new ExcelInvoices;
                    console.log("🚀 ~ file: InvoiceListTable.vue:308 ~ excel ~ ExcelInvoices:", ExcelInvoices)
                    console.log("🚀 ~ file: InvoiceListTable.vue:321 ~ excel ~ pp:", pp)
                    
                    pp.downloadExcel(invoices) */
