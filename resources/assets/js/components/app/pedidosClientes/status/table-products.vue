            ...
            <table class="table table-hover table-borderless ">
                <thead>
                    <tr class="table-custom-header">
                        ...
                        <th class="text-center" style="width:33%">Producto</th>
                ...
                <tfoot >
                    <tr class="custom-foot">
                        <th class="text-right" colspan="5">Neto: {{ NetoTotal | currency}}</th>
        ...
        computed : {
            ...
            NetoTotal(){
                if (this.ItemsToFacturar) {
                    return collect(this.ItemsToFacturar).sum('neto_import');
                }
            ...
            Total(){
                if (this.ItemsToFacturar) {
                    return collect(this.ItemsToFacturar).sum('total_raw');
                }
